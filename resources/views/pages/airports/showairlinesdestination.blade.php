...
<div class="card">
   ...
   <div class="row">
    ...
    <div class="col-md-3">
        <div class="card mb-3">
            <div class="card-header fw-bold"><img src="https://cdn.vectorstock.com/i/500p/14/88/a-soccer-ball-with-the-flag-of-brunei-vector-2001488.jpg" style="width: 25px; height: 25px;"> Domestic</div>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body overflow-auto">
                <iframe src="https://globe.adsbexchange.com/?lat=4.9&lon=114.9&zoom=7" width="100%" height="600" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
